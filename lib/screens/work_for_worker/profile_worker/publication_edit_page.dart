                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              maxLines: 5,
                              maxLength: 5000,
                              initialValue: tokenStore.accessToken,
                              inputFormatters: [
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text('договорная',
                              style: TextStyle(color: widget.model.isContractual ? AppColors.white : AppColors.primary),),
                          ),
                        ),
                  ...
                  child: GestureDetector(
                    onTap: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        var createPublication = await RestServices().editPublication(
                            EditPublication(
