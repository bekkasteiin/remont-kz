...
class MessagePage extends StatefulWidget {
  String? chatId;
  int categoryId;
  MessagePage({Key? key, this.chatId, required this.categoryId})
      : super(key: key);
...
class _MessagePageState extends State<MessagePage> {
  ...
  void updatePage()async{
    List<ChatList> loadChat = await RestServices().getMyAllMessage();
  ...
  void _loadMessages() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        final messages = (jsonDecode(responseChat) as List)
            .map((e) => ChatRoom.fromJson(e as Map<String, dynamic>))
            .toList();
        messages.sort((a, b) => b.id!.compareTo(a.id ?? 0));
  ...
  addToMessages(String text) {
    ...
    if (messagesList.first.executorUsername == profile.username) {
      if (messagesList.first.senderUsername == profile.username) {
        _recipientUsername = messagesList.first.clientUsername ?? '';
      } else {
        _recipientUsername = messagesList.first.senderUsername ?? '';
      }
    } else {
      _recipientUsername = messagesList.first.executorUsername ?? '';
    }
      ...
      appBar: AppBar(
        ...
        title: ListTile(
          ...
          leading: listChatAll.photoUrl != null
            ...
            child: Icon(Icons.person, color: AppColors.primary, size: 25.h,),
          ),
          title: Text(listChatAll.userFullName ?? '',
              style:
                  theme.textTheme.headline6?.copyWith(color: AppColors.white)),
        ),
      ),
      body: Stack(
        fit: StackFit.expand,
                ...
                child: messagesList.length > 0
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          if (messagesList[index].senderUsername == profile.username) {
                            return Column(
                              children: [
                                isClientService
                                    ? messagesList[index].isSystemContent!
                                        ? getMessageByStatus(
                                            ...
                                            decoration: BoxDecoration(
                                              boxShadow: [
                                                BoxShadow(
                                                  ...
                                                  blurRadius: 4,
                                                  offset: Offset(0,
                                                      2.w), // changes position of shadow
                                                ),
                                              ],
                                              borderRadius:
                ...
                child: Column(
                  children: [
                    listChatAll.status == "TASK_REQUEST_FROM_EXECUTOR" &&
                                    ...
                                    child: CupertinoButton(
                                      ...
                                      onPressed: () {
                                        showModalBottomSheet(
                                            ...
                                            }).then((value) => setState((){_loadMessages();}));
                        ...
                        : listChatAll.status == "TASK_APPROVED" && isClientService
                            ? Column(
                                children: [
                                  SingleChildScrollView(
                                    scrollDirection: Axis.horizontal,
                        ...
                        isClientService
                                                                ...
                                                                child:
                                                                    CupertinoButton(
                                                                        ...
                                                                        onPressed:
                                                                            () async {
                                                                          await RestServices()
                                                                              .selectSpecialist(widget.chatId);
                                                                          setState(
                                                                              () {});
                                                                        }),
                                                              ),
                                ...
                                : const SizedBox(),
                    listChatAll.status == "TASK_COMPLETED" && isClientService == false
                        ? Row(
                            children: [
                              Image.asset(
                        ...
                        : listChatAll.status == "TASK_COMPLETED" && isClientService
                            ?
                      !serviceBool?
                    Container(
                                margin: EdgeInsets.all(8.h),
                            ...
                            : const SizedBox(),
                    listChatAll.status == "PUBLICATION_APPROVED_BY_CLIENT" &&
                        ...
                        : listChatAll.status == "PUBLICATION_REJECTED_WORK" &&
                        isClientService
                            ?
                        !serviceBool
                    ?
                    ...
                    listChatAll.status == "TASK_CANCELED" && isClientService
                        ? const SizedBox()
                        : listChatAll.status == "TASK_REJECTED" && isClientService
                            ? const SizedBox()
