...
class GetPublicationOrTaskByCategory extends StatefulWidget {
  ...
  GetPublicationOrTaskByCategory({Key? key, required this.category})
      : super(key: key);

  @override
  State<GetPublicationOrTaskByCategory> createState() =>
      _GetPublicationOrTaskByCategoryState();
}

class _GetPublicationOrTaskByCategoryState
    extends State<GetPublicationOrTaskByCategory> {
  CitiesModel? cities;
  dynamic timesWork;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: FutureBuilder(
          future: !listFilter
              ? RestServices().getAllTaskByCategory(widget.category.id)
              : RestServices().getAllTaskByCategoryFilter(
