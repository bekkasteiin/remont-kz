  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      backgroundColor: AppColors.white,
        body: FutureBuilder(
          future: tokenStore.accessToken!= null ? RestServices().getPublicationByIdAccessToken(widget.id) :RestServices().getPublicationById(widget.id),
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                            onTap: tokenStore.accessToken!=null ? ()async {
                                              ...
                                              if(model.favourite){
                                                await RestServices().deleteFavouritePublication(model.id.toString());
                                              }else{
                                                await RestServices().addFavourite(model.id.toString());
                                              }
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                FutureBuilder(
                                    future: RestServices().getAllReviewByPublication(
                                        model.user.username ?? ''),
                                    builder: (BuildContext context,
                                        AsyncSnapshot snapshotReview) {
                                      if (snapshotReview.hasData) {
                                        List<PublicationReview> reviewModel =
                                            snapshotReview.data;
                                                        ...
                                                        children: [
                                                          Text(
                                                            ...
                                                            style: AppTextStyles
                                                                ...
                                                                .copyWith(
                                                                color:
                                                                AppColors.additionalGreenMedium),
                                                          ),
                                                          Image.asset(
                                        ...
                                        GestureDetector(
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                              ...
                                              style: AppTextStyles.bodyPrimary.copyWith(color: AppColors.white),
                                            ),
                                          ),
                                        ),
                                      ],
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    fontSize: 14.w, color: AppColors.primaryGray),
